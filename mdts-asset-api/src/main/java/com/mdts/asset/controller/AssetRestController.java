...
public class AssetRestController {
	...
	@GetMapping
	public ResponseEntity<List<Asset>> getAssetList(@RequestParam Sort sort, @RequestParam String fieldName){
		log.debug("AssetController, getAssetList begin sort={} by field={}", sort, fieldName);
		try {
			List<Asset> response = service.getAssetList(Direction.fromString(sort.name()), fieldName);
